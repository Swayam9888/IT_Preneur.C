...
int main()
{
  int menu_No, pizzaOption, burgerOption, colddrinkOption;
  ...
  if (menu_No == 1)
  {
    printf("Enter V for Veg Pizza and N for Nonveg Pizza ");
    getchar();
  ...
  {
    printf("Enter V for Veg Burger and N for Nonveg Burger ");
    getchar();
    scanf("%c", &VegOrnon_Veg);
    if (VegOrnon_Veg == 'V' || VegOrnon_Veg == 'v')
    {
  ...
  {
    printf("Enter J forJuice and C for Cold Drinks ");
    getchar();
